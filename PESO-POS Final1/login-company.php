...
<head>
  ...
  <title>PESO-POS | Login Employer</title>
...
<body background="img/photocompany.jpg" style="background-size: cover">
<div class="login-box" style="opacity: 0.93">
<div class="login-box">
  <div class="login-logo">

    <a href="index.php"><b>PESO </b><img src="img/PESO_logo.png" width="75px"> POS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg h3">Employer Login</p>
      ...
      <div class="row">
        ...
        <?php 
              ...
              if(isset($_SESSION['registerCompleted'])) {
                ?>
                <div>
                  <br><p class="text-center text-info">You Have Registered Successfully! Your Account Approval Is Pending By Admin</p>
                </div>
              <?php
              ...
              if(isset($_SESSION['companyLoginError'])) {
                ?>
                <div>
                  <br><p class="text-center text-danger"><?php echo $_SESSION['companyLoginError'] ?></p>
                </div>
              <?php
