...
if(isset($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO job_post(id_company, jobtitle, vacant, description, minimumsalary, maximumsalary, experience, qualifications) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");

	$stmt->bind_param("isssssss", $_SESSION['id_company'], $jobtitle, $vacant, $description, $minimumsalary, $maximumsalary, $experience, $qualifications);
