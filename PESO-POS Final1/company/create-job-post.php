      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <p>Post your Job Vacancies in this Section.</p><br>
                 <div class="form-group col-md-4 pull-right">
                    <label>Job Posted On:</label>
                <input class="form-control input-md" type="text" value="<?php echo date("d-M-Y"); ?>" readonly>
                  </div>
            <div class="row">
              <form method="post" action="addpost.php">
                <div class="col-md-12 latest-job ">
                  ...
                  <div class="form-group col-md-12">
                    <input class="form-control input-md" type="text" id="jobtitle" name="jobtitle" placeholder="Job Title" Required>
                  </div>

                  <div class="form-group col-md-12">
                    <label>Job Description / Responsibilites / Skills Required :</label>
                    <textarea class="form-control input-md" id="description" name="description" placeholder="Job Description" style="resize: none"></textarea>
                  </div>

                  <div class="form-group col-md-12">
                    <input type="text" class="form-control  input-md" id="qualifications" name="qualifications" placeholder="Qualification Required" required="">
                  </div>


                  <div class="form-group col-md-6">
                    <input type="number" class="form-control  input-md" id="minimumsalary" min="1000" autocomplete="off" name="minimumsalary" placeholder="Minimum Salary" required="">
                  </div>
                  <div class="form-group col-md-6">
                    <input type="number" class="form-control  input-md" id="maximumsalary" name="maximumsalary" placeholder="Maximum Salary" required="">
                  </div>
                  <div class="form-group col-md-6">
                <input type="number" class="form-control  input-md" id="experience" autocomplete="off" name="experience" placeholder="Experience (in Years) Required" required="">
                  </div>               
                 <div class="form-group col-md-6">
                    <input class="form-control input-md" type="number" id="vacant" name="vacant" placeholder="Vacancy Count" Required>
                  </div>
