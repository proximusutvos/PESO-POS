...
if(isset($_POST)) {
	...
	$sql = "UPDATE company SET companyname='$companyname', name='$name', website='$website', province='$province', city='$city', contactno='$contactno', phoneno='$phoneno', aboutme='$aboutme'";
