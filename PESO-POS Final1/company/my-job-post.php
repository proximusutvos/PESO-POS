...
$sql1 = "SELECT id_jobpost, COUNT(*) AS count FROM apply_job_post WHERE id_company='$_SESSION[id_company]' AND status='5'";
...
?>
                        ...
                        <td><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><i class="fa fa-address-card-o"></i></a>
                            <a href="delete-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><i class="fa fa-trash text-red"></i></a></td>
                      </tr>
                      <?php
                       }
                     }
