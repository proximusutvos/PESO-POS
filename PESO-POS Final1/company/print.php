               ...
               $sql = "SELECT * FROM users WHERE id_user='$_GET[id]'";
                ...
                <tr>
                  ...
                  <td><img class="col-md-6" style="width: 150px;height: 120px" src="../uploads/resume/<?php echo $row['logo']; ?>" alt="profile">
                   ...
                   <sup class="text-info"><b><i><?php echo $row['email']. ' <br> ' .$row['contactno']; ?></i></b></sup><br>
                   <sup class="text-info"><b><i><?php echo $row['media']; ?></i></b></sup>
                 </center>
                ...
                <div>
                  ...
                  echo $row['aboutme'];
                  ?>
                  <hr><h3><b>Personal Informations</b></h3>
                  <?php
                  ...
                  ?>
                  <hr><h3><b>Educational Background</b></h3>
                  <?php
                  echo '<h4>Primary Education: <br></h4>';
                  echo 'School: ' .$row['primaryschool'];
                  echo '<br>Graduated on: ' .$row['primarypassingyear'];
                  echo '<br>Academic Award: ' .$row['primaryhonor']. '<br><br>';

                  echo '<h4>Secondary Education: <br></h4>';
                  echo 'School: ' .$row['secondaryschool'];
                  echo '<br>Graduated on: ' .$row['secondarypassingyear'];
                  echo '<br>Academic Award: ' .$row['secondaryhonor']. '<br><br>';

                  echo '<h4>Tertiary Education: <br></h4>';
                  echo 'School: '.$row['school'];
                  echo '<br>Graduated on: ' .$row['passingyear'];
                  echo '<br>Course / Degree: ' .$row['qualification'];
                  echo '<br>Academic Award: ' .$row['honor']. '<br><br>';
                  ?>
                  <hr><h3><b>Work Experience</b></h3>
                  <?php
                  echo 'Worked from '.$row['workexperiencecompany'];
                  echo ' as '.$row['workexperiencejob'];
                  echo ' for '.$row['workexperienceyear']. ' year/s';
                  ?>
                ...
                <div class="pull-right no-print col-md-0">
                  <a href="job-applications.php" class="btn btn-danger btn-lg btn-flat margin-top-20"></i>Back</a>
                </div>
