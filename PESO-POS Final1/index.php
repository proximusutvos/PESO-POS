...
================================================== -->
  <body>
    ...
    <div class="jumbotron" style="padding-top: 60px">
                  ...
                  <div>
                    <img id="logongpaniqui" src="img/paniquilogo.png" style="width: 120px;float: left;margin-top: 10px">
                  </div>

                  <div style="float: left;padding-left: 20px;margin-top: 10px">
                   <h4 class="text-red" align="left" style="color: black;font-family: Book Antigua;margin-bottom: -15px;letter-spacing: 2px">Republic of the Philippines</h4>
                   <hr class="text-red" align="left" style="border-color:black;width: 100%">
                   <h2 class="" align="left" style="font-size: 36px;color: black;font-family: Book Antigua;margin-top: -18px;text-shadow: 1px 1px 5px green"><b>Municipality of Paniqui</b></h2>
                    <hr class="text-red" align="left" style="border-color:black;width: 100%;margin-top: -6px">
                    <h6 align="center" style="font-size: 9px;margin-top: -17px;letter-spacing: 2px">Public Employment Services Office - Paniqui Online System</h6>
                  </div>
                 </div>
          ...
          <!-- small box -->
          <div class="small-box bg-red col-xs-2 pull-right" style="margin-top: -112px;margin-right: 20px">
            <div class="inner">
             <?php
          ...
          <div class="small-box bg-blue col-xs-2 pull-right" style="margin-top: -112px;margin-right: 20px">
            <div class="inner">
             <?php
            ...
            <div class="icon">
              <i class="ion ion-ios-people"></i>
                    ...
                    <div class="small-box bg-yellow col-xs-2 pull-right" style="margin-top: -112px;margin-right: 20px">
            <div class="inner">
             <?php
...
<hr>
    ...
    <section id="about" class="content-header">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <img src="img/peso1.jpg" class="img-responsive">
          </div>
