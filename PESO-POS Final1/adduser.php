...
if(isset($_POST)) {
	...
	if($uploadOk == false) {
		...
		$sql = "INSERT INTO users(firstname, middlename, lastname, email, password, address, province, city, contactno, qualification, school, passingyear, dob, age, gender, media, logo, hash, aboutme, skills) VALUES ('$firstname', '$middlename', '$lastname', '$email', '$password', '$address', '$province', '$city', '$contactno', '$qualification', '$school', '$passingyear', '$dob', '$age', '$gender', '$media', '$file', '$hash', '$aboutme', '$skills')";
