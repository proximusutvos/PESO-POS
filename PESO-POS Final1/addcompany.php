...
if(isset($_POST)) {
	...
	if($result->num_rows == 0) {
		...
		$sql = "INSERT INTO company(name, companyname, country, province, city, contactno, phoneno, position, website, email, password, aboutme, logo) VALUES ('$name', '$companyname', '$country', '$province', '$city', '$contactno', '$phoneno', '$position', '$website', '$email', '$password', '$aboutme', '$file')";
