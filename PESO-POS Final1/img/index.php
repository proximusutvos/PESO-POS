...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><img src="img/PESO_logo.png" width="45px"><b> PESO</b> Online</span>
    </a>
 ...
 <!--     <li>
            ...
            <img class="attachment-img" src="uploads/logo/<?php echo $row1['logo']; ?>" alt="Attachment Image">
              <div class="attachment-pushed">
                ...
                <div class="attachment-text">
                    <div><strong><?php echo $row1['companyname']; ?> | <?php echo $row1['city']; ?> | Experience <?php echo $row['experience']; ?> Year/s</strong></div>
                </div>
              </div>
            </div>
          <?php
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 about-text margin-bottom-20">
            <p>The Public Employment Service Office or PESO is a non-fee charging multi-employment service facility or entity established or accredited pursuant to Republic Act No. 8759 otherwise known as the PESO Act of 1999.
            </p>
            <p>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2018-2019 <a href="#">PESO Online Employment</a>.</strong> All rights
    reserved.
    </div>
  </footer>
