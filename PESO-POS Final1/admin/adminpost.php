      ...
      <div class="container" style="min-height: 600px">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="adminpost.php"><i class="fa fa-file"></i> Create Post</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Create Admin Post</i></h2>
            <p>Post some important stuff.</p><br>
              ...
              <form method="post" action="addpost.php">
                <div class="col-md-12 latest-job ">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input class="form-control input-md" type="text" id="subjecttitle" name="subjecttitle" placeholder="Subject Title">
                  </div>

                  <div class="form-group col-md-12">
                    <label>What:</label>
                    <textarea class="form-control input-md" id="what" name="what" placeholder="what" style="resize: none"></textarea>
                  </div>

                 <div class="form-group col-md-6">
                    <label>When:</label>
                    <input class="form-control input-md" type="date" id="postwhen" name="postwhen" placeholder="Vacancy Count">
                  </div>

                  <div class="form-group col-md-6">
                    <label>Where:</label>
                    <input type="text" class="form-control  input-md" id="placewhere" name="placewhere" placeholder="Qualification Required">
                  </div>
