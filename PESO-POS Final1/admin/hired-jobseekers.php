      ...
      <div class="container" style="min-height: 526px;padding-bottom: 50px">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <h3><a href="applications.php">Job Seekers</a></h3><h3><a href="hired-jobseekers.php">Status</a></h3>
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      <?php
                       $sql = "SELECT * FROM users INNER JOIN apply_job_post ON users.id_user=apply_job_post.id_user INNER JOIN job_post ON apply_job_post.id_jobpost=job_post.id_jobpost INNER JOIN company ON job_post.id_company=company.id_company";
                      ...
                      ?>
                      <tr>
                        <td><b><?php echo $row['firstname'].' '.$row['lastname'].'</b> <br>'.$row['email']; ?></td>
                        <td><?php echo '<b>' .$row['jobtitle']. '</b><br>' .$row['companyname']?></td>
                  ...
                  if($row['status'] == 0) {
                    ...
                    echo '<div><strong class="text-yellow">Being Hired</strong></div> ';
