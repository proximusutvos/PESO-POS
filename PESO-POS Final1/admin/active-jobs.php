...
$sql = "SELECT id_jobpost, COUNT(*) AS count FROM apply_job_post GROUP BY id_jobpost";
...
?>
                  ...
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><i class="fa fa-address-card-o"></i></a>
                            <a href="delete-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><i class="fa fa-trash text-danger"></i></a></td>
                      </tr>  
                            <?php
                        }
                      }
  ...
  <!-- /.content-wrapper -->
    ...
    <footer class="main-footer bg-black text-center" style="margin-left: 0px;position: absolute;width: 100%;>
