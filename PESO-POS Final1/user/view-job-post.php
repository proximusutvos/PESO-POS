...
<body>
  ...
  <div class="content-wrapper" style="margin-left: 0px;padding-top: 80px;min-height: 622px">
          ...
          <div class="col-md-3">
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <hr>
                <div class="row">
                  <div class="col-md-4"><a class="text-danger" href="cancelapply.php"><i class="fa fa-arrow-circle-left"></i>Back</a></div>
