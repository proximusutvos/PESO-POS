...
if(isset($_GET['filter']) && $_GET['filter']=='province') {

  $sql = "SELECT * FROM company WHERE province='$_GET[search]'";
         ...
         <div class="attachment-block clearfix">
                ...
                <div class="attachment-pushed">
                  ...
                  <div class="attachment-text">
                      <div><strong><?php echo $row1['companyname']; ?> | <?php echo $row1['province']; ?> | Experience <?php echo $row['experience']; ?> Years</strong></div>
                  </div>
                </div>
              </div>
